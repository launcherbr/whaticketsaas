...
const extractPhoneNumber = (jid: string): string => {
  ...
  // CORREÇÃO: Retorna o número completo sem cortes.
  // A validação se deve ter 12 ou 13 dígitos (dependendo do DDD) 
  // agora é responsabilidade exclusiva do CreateOrUpdateContactService.
  return cleanNumber;
};
